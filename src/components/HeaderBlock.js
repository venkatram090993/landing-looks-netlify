...
const HeaderBlock = () => {
  ...
  return (
    <div class="lg:h-screen lg:leading-normal overflow-y-hidden sm: w-full sm: h-screen bg-red-600">
        ...
        <div class="flex flex-row w-full">
          ...
          >
            <p class="lg:text-6xl md:text-3xl leading-normal text-white sm: text-2xl text-center">
              <span class="sm: font-bold lg:font-normal text-purple-400">Looks</span>, a sassy new way to fashion vlog.
            </p>
