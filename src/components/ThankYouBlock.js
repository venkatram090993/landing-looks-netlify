...
const ThankYouPage = props => {
  ...
  const PrevThanksDiv = (
    <div class="lg:m-auto lg:px-24 sm: pb-10 ">
      {/* <img
        src={wreathImg}
        class="w-3/12 lg:w-2/12 m-auto lg:hidden md:hidden sm: hidden"
        alt="Thank you page"
      /> */}
      {/* <h1 class="text-center m-auto lg:text-5xl sm: text-3xl">Thank You.</h1> */}
      <h1 class="lg:text-left text-center lg:text-5xl sm: text-5xl">
        You're Registered
      </h1>
      ...
      <p class=" lg:text-left text-center  lg:pt-10 lg:text-3xl sm: text-base lg:block md:hidden sm: hidden">
      ...
      <div>
        <form>
          <div class="flex lg:flex-row mt-5 lg:m-0 sm: flex-col sm: w-5/6 sm: m-auto" id="form-div">
            <input
    ...
    <Layout>
      <div class="flex flex-row h-screen">
        ...
        <div class="h-full overflow-y-hidden lg:w-3/6 md:w-full sm: w-full">
          <img src={bgPic} class=" lg:hidden md:block sm: block lg:h-full md:w-full lg:w-full sm: h-full" />
